# This is a Python Dictionary that contains all of the students in a class as well as their grades.
...
# This is the Algorithm! It sorts the students into pairs based on their grades.
